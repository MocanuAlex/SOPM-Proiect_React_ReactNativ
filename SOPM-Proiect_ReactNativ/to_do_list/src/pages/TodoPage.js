...
// ... TEMELE (lightTheme / darkTheme) RĂMÂN NESCHIMBATE ...
const lightTheme = {
  bgColor: "#dbe2ea",
  cardBg: "#f8faff",
  textColor: "#1a202c",
...
// ... STILURILE MODIFICATE PENTRU LAYOUT VERTICAL PE CARD ...
const styles = StyleSheet.create({
  ...
  task: {
    ...
    borderLeftWidth: 12,
    marginBottom: 20,
    // --- MODIFICARE CHEIE: Column în loc de Row ---
    flexDirection: "column",
    alignItems: "stretch", // Elementele ocupă toată lățimea
  },
  taskInfo: {
    marginBottom: 15, // Spațiu între informații și butoane
  },
  taskText: {
    fontWeight: "800",
    fontSize: 20,
  ...
  badgesContainer: {
    ...
    gap: 10,
    marginTop: 12,
    flexWrap: "wrap", // Permite etichetelor să treacă pe rândul următor
  },
  badge: {
  ...
  actions: {
    ...
    gap: 12,
    alignItems: "center",
    justifyContent: "flex-end", // Aliniere la dreapta
    width: "100%",
  },
  btnEdit: {
    padding: 5,
